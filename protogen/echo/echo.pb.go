...
type EchoResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	Hostname      string                 `protobuf:"bytes,2,opt,name=hostname,proto3" json:"hostname,omitempty"`              // Pod 的 hostname
	PodName       string                 `protobuf:"bytes,3,opt,name=pod_name,json=podName,proto3" json:"pod_name,omitempty"` // Pod 名称（从环境变量获取）
	PodIp         string                 `protobuf:"bytes,4,opt,name=pod_ip,json=podIp,proto3" json:"pod_ip,omitempty"`       // Pod IP（从环境变量获取）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_echo_proto_rawDesc = "" +
	...
	"\x06pod_ip\x18\x04 \x01(\tR\x05podIp25\n" +
	"\x04Echo\x12-\n" +
	"\x04Echo\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponseB,Z*github.com/hj24/grpc-lb-test/protogen/echob\x06proto3"
